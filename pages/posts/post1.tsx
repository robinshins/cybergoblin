...
const Post1 = () => {
  ...
  return (
    <>
      <Head>
        <title>ComfyUI를 활용한 실시간 이미지 생성 시스템 구축하기</title>
        <meta name="description" content="ComfyUI를 사용하여 실시간 이미지 생성 시스템을 구축하는 방법을 상세히 알아봅니다. 시스템 구성부터 최적화, 보안까지 완벽한 가이드." />
        <meta property="og:title" content="ComfyUI를 활용한 실시간 이미지 생성 시스템 구축하기" />
        <meta property="og:description" content="ComfyUI를 사용하여 실시간 이미지 생성 시스템을 구축하는 방법을 상세히 알아봅니다. 시스템 구성부터 최적화, 보안까지 완벽한 가이드." />
